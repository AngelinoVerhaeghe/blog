...
@section('content')
    ...
    <div class="w-4/5 m-auto pt-20">
        <form action="/blog" method="POST" enctype="multipart/form-data">
            ...
            <button type="submit"
                class="uppercase mt-15 bg-blue-500 text-gray-100 text-lg font-extrabold py-4 px-8 rounded-3xl shadow-md hover:bg-blue-600 transition duration-300 ease-in-out">
                Submit Post
            </button>
        </form>
    </div>
