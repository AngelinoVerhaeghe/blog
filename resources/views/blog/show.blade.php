            ...
            <div class="lg:grid lg:grid-cols-2 lg:gap-10">
                <div class="flex">
                    <img src="{{ $post->photo ? asset('posts/images/' . $post->photo->file) : 'https://place-hold.it/300x500' }}"
                        class="object-fit" alt="{{ $post->title }}">
                </div>
                ...
                <div class="p-4 space-y-4 xl:space-y-8 xl:mt-4">
                    ...
                    <div class="flex justify-end">
                        <a href="{{ url('/blogs') }}"
                            class="inline uppercase bg-gray-600 text-gray-100 text-sm font-extrabold py-2 px-4 md:px-5 rounded-3xl shadow-md hover:bg-gray-700 transition duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">Back</a>
                    </div>
                </div>
            </div>
        </div>
